{
  ...
  inputs = {
    ...
    macemu.url = "github:kanjitalk755/macemu";
    macemu.flake = false;
  };
  ...
  outputs = inputs@{ flake-parts, ... }:
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem = { config, self', inputs', pkgs, system, ... }: {
        ...
        packages.minivmac = if pkgs.stdenv.isLinux then
        ...
        packages.rom = pkgs.fetchurl {
          url =
            "https://raw.githubusercontent.com/mihaip/infinite-mac/47d697538ba8a99bd0cf217c4dd404894c6944bb/src/Data/Mac-Plus.rom";
        ...
        packages.ua608d = pkgs.stdenv.mkDerivation {
          ...
          src = pkgs.fetchurl {
            url =
              "https://www.gryphel.com/d/minivmac/extras/ua608d/ua608d-1.00.src.tgz";
        ...
        packages.system608 = let
          ssw1 = pkgs.fetchurl {
            url =
              "https://download.info.apple.com/Apple_Support_Area/Apple_Software_Updates/English-North_American/Macintosh/System/Older_System/System_6.0.x/SSW_6.0.8-1.4MB_Disk1of2.sea.bin";
            sha256 = "sha256-4YAa7yOfWnQ7DJA9UDQiz5jlE9Alpjfdi3dRIgg7Hag=";
          };
          ssw2 = pkgs.fetchurl {
            url =
              "https://download.info.apple.com/Apple_Support_Area/Apple_Software_Updates/English-North_American/Macintosh/System/Older_System/System_6.0.x/SSW_6.0.8-1.4MB_Disk2of2.sea.bin";
            sha256 = "sha256-pwNgazUPQh0BcmVNl7H6I/MuskmFFl+/L0wfTzE43Xg=";
          };
        in pkgs.runCommand "system608" { } ''
          mkdir -p $out/
        ...
        packages.launchappl_minivmac = let
          autoquitZIP = pkgs.fetchurl {
            url =
              "https://www.gryphel.com/d/minivmac/extras/autoquit/autoquit-1.1.1.zip";
          ...
          '';
        in pkgs.runCommand "launchappl_minivmac" {
          shellHook = ''
            ...
            export RETRO68_LAUNCHAPPL_EMULATOR=minivmac
          '';
        } ''
          mkdir -p $out
        '';

        packages.basilisk2 = pkgs.stdenv.mkDerivation {
          name = "basilisk2";
          ...
          patchPhase = ''
            sed -i 's$#include <linux/../scsi/sg.h>.*$#include <scsi/sg.h>$' BasiliskII/src/Unix/Linux/scsi_linux.cpp
          '';
        ...
        packages.sheepshaver = pkgs.stdenv.mkDerivation {
          name = "sheepshaver";
